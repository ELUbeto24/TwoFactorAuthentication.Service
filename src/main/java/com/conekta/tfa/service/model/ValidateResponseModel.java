...
public class ValidateResponseModel {
	...
	@Column(name = "authenticationTransactionID", length = 50, nullable = false)
	...
	@Column(name = "commerceIndicator", length = 10, nullable = true)
    public String commerceIndicator;
	
	@Column(name = "reasonCode", length = 5, nullable = true)
    public String reasonCode;
	
	@Column(name = "cavvAlgorithm", length = 5, nullable = true)
    public String cavvAlgorithm;
	
	@Column(name = "eciRaw", length = 5, nullable = true)
    public String eciRaw;
	
	@Column(name = "eci", length = 5, nullable = true)
    public String eci;
	
	@Column(name = "authenticationResult", length = 5, nullable = true)
    public String authenticationResult;
	
	@Column(name = "requestId", length = 50, nullable = true)
    public String requestID;
	
	@Column(name = "paresStatus", length = 5, nullable = true)
	...
	@Column(name = "avv", length = 50, nullable = true)
    public String avv;
